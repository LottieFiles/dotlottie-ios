...
int32_t uniffi_dotlottie_player_fn_method_dotlottieplayer_state_machine_set_boolean_trigger(void*_Nonnull ptr, RustBuffer key, int8_t value, RustCallStatus *_Nonnull out_status
);
#endif
...
int32_t uniffi_dotlottie_player_fn_method_dotlottieplayer_state_machine_set_numeric_trigger(void*_Nonnull ptr, RustBuffer key, float value, RustCallStatus *_Nonnull out_status
);
#endif
...
int32_t uniffi_dotlottie_player_fn_method_dotlottieplayer_state_machine_set_string_trigger(void*_Nonnull ptr, RustBuffer key, RustBuffer value, RustCallStatus *_Nonnull out_status
);
#endif
