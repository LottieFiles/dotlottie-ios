...
public class DotLottiePlayer: DotLottiePlayerProtocol {
    ...
    public convenience init() {
        self.init(unsafeFromRawPointer: try! rustCall {
            uniffi_dotlottie_player_fn_constructor_dotlottieplayer_new($0)
        })
    }
    ...
    public func loadAnimation(animationData: String, width: UInt32, height: UInt32) -> Bool {
        return try! FfiConverterBool.lift(
            try!
                rustCall {
                    uniffi_dotlottie_player_fn_method_dotlottieplayer_load_animation(self.pointer,
    ...
    public func loadAnimationFromPath(path: String, width: UInt32, height: UInt32) -> Bool {
        return try! FfiConverterBool.lift(
            try!
                rustCall {
                    uniffi_dotlottie_player_fn_method_dotlottieplayer_load_animation_from_path(self.pointer,
