...
help:
	...
	@echo "  make apple WEBGPU=0          - Same, but software-only (no wgpu-native, no WgpuNative.xcframework)"
	...
	@echo "  Sources/DotLottieCore/WgpuNative.xcframework   (skipped when WEBGPU=0)"
